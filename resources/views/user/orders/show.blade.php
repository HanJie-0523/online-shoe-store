<x-layouts.user>
    ...
    <div class="col">
        <div class="d-flex">
            ...
            <div>
                <a href="{{ route('user.orders.edit', ['order' => $order]) }}" class="btn btn-sm btn-success">Edit</a>
            </div>
        </div>
        <div class="col">
            Name: {{ $order->name }}
        ...
        <div class="col py-3">
            ...
            <div class="col">
                <div class="d-flex">
                    ...
                    <div class="px-1">
                        <form method="POST" action="{{ route('user.orders.destroy', ['order' => $order]) }}">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="px-1">
                        <form method="POST" action="{{ route('orders.createPayment', $order) }}">
                            @csrf
